from numpy import array, ndarray, std, argsort, where, random, concatenate, unique
...
def random_forests_study(
    ...
    if best_params["params"]:
        ...
        print("RF: No model better than baseline found.")
...
def run_random_forest_study(nr_max_trees: int = 1000, lag: int = 250):
    ...
    if best_model is None:
        print("RF: Returning early because no model outperformed baseline.")
        return
