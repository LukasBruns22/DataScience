...
savefig(f"Lab6/results/ARIMA/parameters_study.png")
...
plot_forecasting_eval(
    train, test, prd_trn, prd_tst, title=f"ARIMA (p={params[0]}, d={params[1]}, q={params[2]})"
)
savefig(f"Lab6/results/ARIMA/evals.png")

plot_forecasting_series(
    train,
    test,
    prd_tst,
    title=f"ARIMA (p={params[0]}, d={params[1]}, q={params[2]})",
    xlabel="Datetime",
    ylabel="Traffic Volume",
)
savefig(f"Lab6/results/ARIMA/forecast.png")